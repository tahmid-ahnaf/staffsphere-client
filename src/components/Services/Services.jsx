...
const Services = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="max-w-screen-md mb-8 lg:mb-16 mx-auto text-center">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Streamline Your Workforce Management with Our Comprehensive Services</h2>
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">Simplify Your Admin, Employee and HR Operations with Our Comprehensive Employee Management Solutions</p>
      </div>
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">User Management</h3>
              <p className="text-gray-500 dark:text-gray-400">Our user management service provides a secure and efficient way to manage user accounts, including registration, login, and role assignment. With our service, you can ensure that only authorized personnel have access to sensitive information and features.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Workflow Management</h3>
              <p className="text-gray-500 dark:text-gray-400">Streamline your workflow with our workflow management service. Employees can easily submit work records, including tasks, hours worked, and dates, which are stored securely in our database. </p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Payment Processing</h3>
              <p className="text-gray-500 dark:text-gray-400">Our payment processing service ensures that employee salaries are paid accurately and on time. Employees can also view their payment history with ease.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Employee Administration</h3>
              <p className="text-gray-500 dark:text-gray-400">Our employee administration service provides HR personnel with a comprehensive platform to manage employee data, including verification, salary payment processing, and status updates.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Admin Control</h3>
              <p className="text-gray-500 dark:text-gray-400"> With our service, administrators can promote employees to HR, adjust salaries, and terminate employee access with ease.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Communication Management</h3>
              <p className="text-gray-500 dark:text-gray-400">Our communication management service provides a secure and efficient way for visitors to contact your company through a contact us form. </p>
          </div>
      </div>
  </div>
</section>
